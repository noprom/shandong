    ...
    <div class="noo-page-heading">
      <div class="container-boxed max text-center parallax-content">
        ...
        <div class="page-heading-info ">
          <h1 class="page-title">
            <c:choose>
              <c:when test="${EDIT != null}">编辑简历</c:when>
                  ...
                  <div class="jform-steps">
                    <ul class="jsteps jsteps-4">
                      ...
                      <li class="active">	                        
                        ...
                        <div class="jstep-label">简历预览</div>
                      </li>
                    </ul>
                  </div>
                </div>
                              ...
                              <div class="resume-preview">
                                ...
                                ' height='160' width='160' />
                                              ...
                                              <div class="col-md-9 col-sm-12">
                                                <div class="skill">
                                                  <c:forEach items="${SKILL_LIST}" var="v" varStatus="s">
                                                    ...
                                                    <div class="progress">
                                                      <div role="progressbar" aria-valuemax="100" aria-valuemin="0" class="progress-bar progress-bar-bg" aria-valuenow="${v.percent}" style="width: ${v.percent}%;">
                                  ...
                                  <div class="form-actions resume-preview-actions text-center clearfix">
                                    <a href="<%=basePath%>user/resume" class="btn btn-primary">确 认</a>
                                  </div>
                                </div>
                              </div>
                            </div>
