    ...
    <div class="container-boxed max">
      <div class="member-heading-nav">
        <ul>
          ...
          <li class="active"><a href="javascript:void(0);"><i class="fa fa-user"></i> 我的账户</a></li>
          <li class="divider" role="presentation"></li>
            ...
            <div class="candidate-profile-form row">
              <div class="col-sm-6">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="current_job" value="" name="current_job" placeholder="您的当前工作">
                  </div>
                </div>
                <div class="form-group">
                  <label for="birthday" class="col-sm-4 control-label">生日</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="birthday" value="" name="birthday" placeholder="您的生日">
                  </div>
                </div>
                <div class="form-group">
                  <label for="address" class="col-sm-4 control-label">地区</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="address" value="" name="address" placeholder="所在地区">
                  </div>
                </div>
                <div class="form-group">
                  <label for="phone" class="col-sm-4 control-label">手机号</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="phone" value="" name="phone" placeholder="您的手机号">
                  </div>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  <label for="description" class="control-label">简介</label>
                    <textarea class="form-control" id="description" name="description" rows="8" placeholder="您的简介"></textarea>
                </div>
                <div class="form-group">
