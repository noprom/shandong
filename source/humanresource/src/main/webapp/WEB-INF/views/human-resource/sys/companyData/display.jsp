            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <%--<div class="box box-danger">--%>
                        ...
                        <%--</div>--%>
                        <%--<div class="box-body">--%>
                            <%--<canvas id="pieChart" style="height: 247px; width: 495px;" width="990"--%>
                                    <%--height="494"></canvas>--%>
                        <%--</div><!-- /.box-body -->--%>
                    <%--</div><!-- /.box -->--%>
                ...
                <%--<div class="col-md-6">--%>
                    ...
                    <%--<div class="box box-info">--%>
                        ...
                        <%--<div class="box-body">--%>
                            <%--<div class="chart">--%>
                                <%--<canvas id="lineChart" style="height: 250px; width: 475px;" width="950"--%>
                                        <%--height="500"></canvas>--%>
                            <%--</div>--%>
                        <%--</div><!-- /.box-body -->--%>
                    <%--</div><!-- /.box -->--%>
                    ...
                    <%--<div class="box box-success">--%>
                        ...
                        <%--<div class="box-body">--%>
                            <%--<div class="chart">--%>
                                <%--<canvas id="barChart" style="height: 230px; width: 475px;" width="950"--%>
                                        <%--height="460"></canvas>--%>
                            <%--</div>--%>
                        <%--</div><!-- /.box-body -->--%>
                    <%--</div><!-- /.box -->--%>
